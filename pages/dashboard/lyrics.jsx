...
export default function LyricsTest () {
    ...
    return (<div style={{display: "flex", alignItems: "center", flexDirection: "column"}}>
        ...
        <LiveLyrics title={"Two words"} audioRef={audioRef} albumCover={`http://aktuelt.tv/api/v1/files/audio/cover?fileId=${fileId}`} lyrics={[
            [
                {
                    millis: 0,
                    line: "(Intro)"
        ...
        <audio ref={audioRef} style={{width: "100%"}}src={`http://aktuelt.tv/api/v1/files?fileId=${fileId}`} controls />
    </div>)
