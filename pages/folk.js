      ...
      <background className={styles.bg}>
        ...
        <video 
          ...
          >
            ...
            <div style={{position: "absolute", zIndex: 10, translate: "-50% -50%", left: "50%", top: "50%", maxWidth: 400}}>
                <h1>Medlemmer</h1>
            </div>
        ...
        <div className={styles.group}>
          <div className={styles.row}>         
            <div className={styles.image} style={{maxWidth: `none`}}>
              <video src={"http://aktuelt.tv/api/v1/files/videos?quality=360&fileId=cda1d6fa-e773-4f3c-b9bb-50f475e5f59a.mp4"} fill autoPlay preload="metadata" loop poster={"http://aktuelt.tv/api/v1/files?fileId=15feab38-2a04-4e74-baf0-07a0383e1830.png"} playsInline style={{objectFit: "cover", objectPosition: "center", width: "100%", height: "100%"}}></video>
            </div>
...
Litagoen. Med nådeløse fiender i hælene og uventede vendepunkter, er det en kamp mot klokken for å finne skatten før det er for sent. Opplev en actionfylt western-film som tar deg med på et episk eventyr fylt med spenning, mysterier og kampen om Litagoen.
                ...
                <div style={{display: "flex", flexWrap: "wrap", gap: ".5rem"}}>
                  <Badge style={{width: "fit-content"}}>Film</Badge>
                  <Badge style={{width: "fit-content", background: "orange"}}>I produksjon</Badge>
                </div>
